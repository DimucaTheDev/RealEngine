...
namespace RE.Debug
{
    public class LineManager : IRenderable, IDisposable
    {
        ...
        private List<LineEntry> _lines = new();
        private int _nextId = 0;
        private List<Vertex> _vertices = new();
        private int _vao, _vbo, _shader;
        private HashSet<int> _toRemove = new();
        ...
        public void Init()
        {
            ...
            int stride = Vector3.SizeInBytes + Vector4.SizeInBytes;
        ...
        public void Render(FrameEventArgs args)
        {
            ...
            Vertex[] vertexData = new Vertex[_lines.Count * 2];
